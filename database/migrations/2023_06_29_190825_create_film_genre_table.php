...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('film_genre', function (Blueprint $table) {
            ...
            $table->primary(['film_id','genre_id'], 'film_genre_pk'); // kompozit, slozeni primarni kljuc iz 2 elementa
            $table->foreign('film_id', 'film_genre_film_fk')->references('id')->on('films')->onUpdate('cascade')->onDelete('cascade');

            $table->foreign('genre_id', 'film_genre_genre_fk')->references('id')->on('genres')->onUpdate('cascade')->onDelete('cascade');
