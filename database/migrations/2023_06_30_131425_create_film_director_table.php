...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('film_director', function (Blueprint $table) {
            ...
            $table->foreign('film_id', 'film_director_film_fk')->references('id')->on('films')->onUpdate('cascade')->onDelete('no action');
            $table->foreign('person_id', 'film_director_people_fk')->references('id')->on('people')->onUpdate('cascade')->onDelete('no action');
        });
    }
